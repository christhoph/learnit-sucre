		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Desarrollo/Homero Torres.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Homero Torres Zarria</h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Magister en Ling&uuml;&iacute;stica y Did&aacute;ctica para la ense&ntilde;anza de Idiomas
								extranjeros. Universidad Central del Ecuador</span>
						...
						<li class="list-item-detail">
							...
							<span>htorres@tecnologicosucre.edu.ec</span>

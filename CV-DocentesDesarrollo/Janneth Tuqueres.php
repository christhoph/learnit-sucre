		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Desarrollo/Janneth Tuqueres.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Janneth Tuqueres Garc&eacute;s </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Licenciada en Matem&aacute;ticas. Universidad Central del Ecuador</span>
						...
						<li class="list-item-detail">
							...
							<span>jtuqueres@tecnologicosucre.edu.ec</span>

		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Desarrollo/Yadira Franco.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Yadira Franco Rocha</h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Ing. An&aacute;lisis de Sistemas. Universidad Aut&oacute;noma de Los Andes (Uniandes)</span>
						...
						<li class="list-item-detail">
							...
							<span>yfranco@tecnologicosucre.edu.ec</span>

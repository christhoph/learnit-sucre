		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Luis Valencia.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Luis Valencia Valencia </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Doctor en Contabilidad y Auditor&iacute;a. Universidad T&eacute;cnica de Ambato</span>
						...
						<li class="list-item-detail">
							...
							<span>dvalencia@tecnologicosucre.edu.ec</span>

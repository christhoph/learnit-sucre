		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Estefania Zambrano.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Estefania Zambrano Cheverria </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>M&aacute;ster en Nuevas Perspectivas de la Educaci&oacute;n. Universidad Internacional de la Rioja
							</span>
						...
						<li class="list-item-detail">
							...
							<span>ezambrano@tecnologicosucre.edu.ec</span>

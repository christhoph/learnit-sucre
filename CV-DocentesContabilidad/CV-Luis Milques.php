		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Luis Milques.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Luis Milques Paredess </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>M&aacutester Universitario en Direcci&oacuten y Asesoramiento Financiero. Universidad Internacional
								de la Rioja</span>
						...
						<li class="list-item-detail">
							...
							<span>lmilques@tecnologicosucre.edu.ec</span>

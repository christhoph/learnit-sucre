		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Paola Gonzalez.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Paola Gonz&aacute;lez Mendoza </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Ingeniera en Ecoturismo. Escuela Superior Polit&eacute;cnica de Chimborazo (Espoch)</span>
						...
						<li class="list-item-detail">
							...
							<span>pgonzalez@tecnologicosucre.edu.ec</span>

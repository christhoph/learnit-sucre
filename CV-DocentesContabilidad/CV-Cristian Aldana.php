		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Cristian Aldana.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">
					<h2 class="Name_Doce">Cristian Aldana Cruz </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Ingeniero en Contabilidad y Auditor&iacute;a CPA. Universidad Polit&eacute;cnica Salesiana</span>
						...
						<li class="list-item-detail">
							...
							<span>caldana@tecnologicosucre.edu.ec</span>

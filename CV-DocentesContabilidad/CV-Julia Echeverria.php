		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Julia Echeverria.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Julia Echeverria Naranjo </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Psicologa Educativa. Universidad Central del Ecuador</span>
						...
						<li class="list-item-detail">
							...
							<span>jecheverria@tecnologicosucre.edu.ec</span>

		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Ricardo Chiliquinga.jpg"
						alt="">
				...
				<div class="col-lg-7 c_details_list">
					...
					<h2 class="Name_Doce">Ricardo Chiliquinga Campos </h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Licenciatura en Ciencias de la Educación Mención Inglés. Universidad Central del Ecuador</span>

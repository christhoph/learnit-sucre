		...
		<div class="col-lg-12 course_details_inner">
			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				...
				<div class="col-lg-5">
					...
					<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Contabilidad/Luis Miranda.jpg" alt="">

				</div>

				<div class="col-lg-7 c_details_list">

					<h2 class="Name_Doce">Luis Miranda Tufi&ntilde;o</h2>
					...
					<ul class="list">
						...
						<li class="list-item-detail">
							...
							<span>Ingeniero Comercial con especializaci&oacute;n en Contabilidad y Auditoria. Universidad
								Polit&eacute;cnica Salesiana</span>
						...
						<li class="list-item-detail">
							...
							<span>lmiranda@tecnologicosucre.edu.ec</span>

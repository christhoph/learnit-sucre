			...
			<div class="col-lg-12 course_details_inner">
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Electricidad/DARWIN%20CUASAPAZ%20ESCOBAR%200401632534.jpeg" alt="">
					</div>
					<div class="col-lg-7 c_details_list">
					    <h2 class="Name_Doce">Andres Cuasapaz Escobar</h2>
					    <br>
					 <ul class="list">
							<li class="list-item-detail">
								<a class="list-title-space">Título: </a>
								<span>Ingeniero Eléctrico, Universidad Técnica del Norte</span>
							</li>
							<li class="list-item-detail">
							...
							<li class="list-item-detail">
								...
								<span>dcuasapaz@tecnologicosucre.edu.ec</span>
							</li>
						</ul>
					</div>
				</div>

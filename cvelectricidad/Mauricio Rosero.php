			...
			<div class="col-lg-12 course_details_inner">
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Electricidad/MAURICIO  ROSERO YUGSI 1714755921.jpeg" alt="">
					</div>
					<div class="col-lg-7 c_details_list">
					    <h2 class="Name_Doce">Mauricio Rosero Yugsi</h2>
					    <br>
					 <ul class="list">
							<li class="list-item-detail">
								<a class="list-title-space">Título: </a>
								<span>Mauricio Rosero
Ingeniero de Sistemas de la Universidad Polit�cnica Salesiana.</span>
							</li>
							<li class="list-item-detail">
							...
							<li class="list-item-detail">
								...
								<span>Tecnolog�a Superior en Electricidad</span>
							</li>
							<li class="list-item-detail">
								<a class="list-title-space">Correo: </a>
								<span>mrosero@tecnologicosucre.edu.ec</span>
								</li>
						</ul>
					</div>
				</div>

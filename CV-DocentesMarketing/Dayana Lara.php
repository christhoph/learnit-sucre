			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Marketing/Dayana Lara.jpg" 
					...
					<div class="col-lg-7 c_details_list">
					    ...
					    <h2 class="Name_Doce">Dayana Lara </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Licenciada en Comunicaci&oacute;n Social. Universidad Polit&eacute;cnica Salesiana</span>
							...
							<li class="list-item-detail">
								...
								<span>dlara@tecnologicosucre.edu.ec</span>

			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Marketing/Juan Basantes.jpg" 
					...
					<div class="col-lg-7 c_details_list">
					    ...
					    <h2 class="Name_Doce">Juan Basantes Carrera</h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Msg. Redes y Telecomunicaciones. Pontificia Universidad Católica del Ecuador (PUCE)</span>
							...
							<li class="list-item-detail">
								...
								<span>jbasantes@tecnologicosucre.edu.ec</span>

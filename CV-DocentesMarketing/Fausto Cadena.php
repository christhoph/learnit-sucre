			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Marketing/Fausto Cadena.jpg" 
					...
					<div class="col-lg-7 c_details_list">
					    ...
					    <h2 class="Name_Doce">Fausto Cadena Pérez</h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>MBA con Mención en Marketing. Universidad de las Américas</span>
							...
							<li class="list-item-detail">
								...
								<span>fcadena@tecnologicosucre.edu.ec</span>

			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Marketing/Valeria Ortiz.jpg" 
					...
					<div class="col-lg-7 c_details_list">
					    ...
					    <h2 class="Name_Doce"> Valeria Ortiz Jaramillo</h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Ingeniera en Finanzas. Universidad de las Fuerzas Armadas (ESPE))</span>
							...
							<li class="list-item-detail">
								...
								<span>vortiz@tecnologicosucre.edu.ec</span>

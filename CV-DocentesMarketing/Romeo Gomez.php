			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Marketing/Romeo Gomez.jpg" 
					...
					<div class="col-lg-7 c_details_list">
					    ...
					    <h2 class="Name_Doce"> Romeo G&oacute;mez Meza </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Ingeniero en Marketing. Universidad Tecnol&oacute;gica Equinoccial</span>
							...
							<li class="list-item-detail">
								...
								<span>rgomez@tecnologicosucre.edu.ec</span>

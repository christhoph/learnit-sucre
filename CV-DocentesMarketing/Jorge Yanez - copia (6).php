			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Marketing/Jorge Yanez.jpg" 
					...
					<div class="col-lg-7 c_details_list">
					    ...
					    <h2 class="Name_Doce">Jorge Y&aacute;nez Intriago </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Ingeniero en Sistemas. Escuela Polit&eacute;cnica Javeriana del Ecuador (Espoj)</span>
							...
							<li class="list-item-detail">
								...
								<span>jyanez@tecnologicosucre.edu.ec</span>

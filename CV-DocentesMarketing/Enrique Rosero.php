			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Marketing/Enrique Rosero.jpg" 
					...
					<div class="col-lg-7 c_details_list">
					    ...
					    <h2 class="Name_Doce">Enrique Rosero Olalla</h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Licenciado en Idiomas. Mención Inglés. Universidad Central del Ecuador</span>
							...
							<li class="list-item-detail">
								...
								<span>erosero@tecnologicosucre.edu.ec</span>

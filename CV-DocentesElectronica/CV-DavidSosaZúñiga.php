			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				<div class="col-lg-5">
					<img class="img-fluid-docentecv"
						src="../img/Docentes/Tradicional/Electronica/DAVID SOSA ZUNIGA 1721734281.jpeg" alt="">
				</div>
				<div class="col-lg-7 c_details_list">
					<h2 class="Name_Doce">David Sosa Zúñiga</h2>
					<br>
					<ul class="list">
						<li class="list-item-detail">
							<a class="list-title-space">Título: </a>
							<span>Magíster en Gestión de Sistemas de Información e Inteligencia de Negocios, Escuela Politécnica del
								Ejercito ESPE</span>
						</li>
						<li class="list-item-detail">
						...
						<li class="list-item-detail">
							...
							<span>dsosa@tecnologicosucre.edu.ec</span>
						</li>
					</ul>
				</div>
			</div>

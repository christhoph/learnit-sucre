			...
			<div class="col-lg-12 course_details_inner">
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Electronica/CARLOS  RIVERA LIGER 0502309552.jpeg" 
								alt="">
								
								
					</div>
					<div class="col-lg-7 c_details_list">
					    <h2 class="Name_Doce">Carlos Rivera Liger </h2>
					    <br>
					 <ul class="list">
							<li class="list-item-detail">
								<a class="list-title-space">Título: </a>
								<span>Ingeniero en Electrónica y Control</span>
							</li>
							<li class="list-item-detail">
							...
							<li class="list-item-detail">
								...
								<span>crivera@tecnologicosucre.edu.ec</span>
							</li>
						</ul>
					</div>
				</div>

			...
			<div class="col-lg-12 course_details_inner">
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/Electronica/Vargas-Mercedes.jpg" alt="">
					</div>
					<div class="col-lg-7 c_details_list">
					    <h2 class="Name_Doce">Mercedes Vargas Moreno</h2>
					    <br>
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Magister en Evaluación y Auditoria de Sistemas Tecnológicos </span>
							</li>
							<li class="list-item-detail">
							...
							<li class="list-item-detail">
								<a class="list-title-space">Correo: </a>
    								<span>mvargas@tecnologicosucre.edu.ec</span>
							</li>
						</ul>
					</div>
				</div>

			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				<div class="col-lg-5">
					<img class="img-fluid-docentecv"
						src="../img/Docentes/Duales/DesarrolloInfantil/LUIS%20CLAVIJO%20QUIZHPI%200300494168.jpg" alt="">
				</div>
				<div class="col-lg-7 c_details_list">
					<h2 class="Name_Doce">Luis Clavijo Quizhpi</h2>
					<br>
					<ul class="list">
						<li class="list-item-detail">
							<a class="list-title-space">Título: </a>
							<span>Licenciada en Ciencias de la Educación.</span>
						</li>
						<li class="list-item-detail">
						...
						<li class="list-item-detail">
							...
							<span>lcalvijo@tecnologicosucre.edu.ec</span>
						</li>
					</ul>
				</div>
			</div>

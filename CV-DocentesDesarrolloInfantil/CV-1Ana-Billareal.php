			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				<div class="col-lg-5">
					<img class="img-fluid-docentecv"
						src="../img/Docentes/Duales/DesarrolloInfantil/ANA%20VILLAREAL%20ROSERO%200400716486.jpg" alt="">
				</div>
				<div class="col-lg-7 c_details_list">
					<h2 class="Name_Doce">Ana Villarreal Rosero</h2>
					<br>
					<ul class="list">
						<li class="list-item-detail">
							<a class="list-title-space">Título: </a>
							<span>Especialista en Gestión de Calidad en Educación, Universidad Andina Simón Bolívar- Ecuador.</span>
						</li>
						<li class="list-item-detail">
						...
						<li class="list-item-detail">
							...
							<span>Tecnología en Desarrollo Infantil Integral (TDII).</span>
						</li>
						<li class="list-item-detail">
							<a class="list-title-space">Correo: </a>
							<span>avillareal@tecnologicosucre.edu.ec</span>
						</li>
					</ul>
				</div>
			</div>

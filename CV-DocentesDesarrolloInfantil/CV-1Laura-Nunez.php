			...
			<div class="col-lg-12 row justify-content-between p-0 m-0">
				<div class="col-lg-5">
					<img class="img-fluid-docentecv"
						src="../img/Docentes/Duales/DesarrolloInfantil/LAURA%20NU%C3%91EZ%20GALARRAGA%201718988973.jpg" alt="">
				</div>
				<div class="col-lg-7 c_details_list">
					<h2 class="Name_Doce">Laura Núñez Galarraga</h2>
					<br>
					<ul class="list">
						<li class="list-item-detail">
							<a class="list-title-space">Título: </a>
							<span>Especialista en Gestión de Calidad en Educación.</span>
						</li>
						<li class="list-item-detail">
						...
						<li class="list-item-detail">
							...
							<span>lnunez@tecnologicosucre.edu.ec</span>
						</li>
					</ul>
				</div>
			</div>

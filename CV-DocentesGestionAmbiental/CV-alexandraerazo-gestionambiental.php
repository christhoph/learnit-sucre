			...
			<div class="col-lg-12 course_details_inner">
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Tradicional/GestionAmbiental/ALEXANDRA ERAZO GUZMAN 1714243506.jpg" alt="">
					</div>
					<div class="col-lg-7 c_details_list">
					    <h2 class="Name_Doce">Alexandra Erazo Gúzman</h2>
					    <br>
					 <ul class="list">
							<li class="list-item-detail">
								<a class="list-title-space">Título: </a>
								<span>Máster en Gestión Ambiental Universidad Internacional SEK.</span>
							</li>
							<li class="list-item-detail">
							...
							<li class="list-item-detail">
								...
								<span>aerazo@tecnologicosucre.edu.ec</span>
							</li>
						</ul>
					</div>
				</div>

...
<html lang="es">
  ...
  <head>
    ...
    <title>Instituto Superior Tecnológico Sucre</title>
        ...
        <div class="container">
          ...
          <div class="float-left">
            ...
            <ul class="list header_social">
              ...
              <li><a href="https://www.facebook.com/SUCREInstitutooficial/" target="_blank"><i
                    class="fab fa-facebook"></i></a></li>

              <li><a href="https://twitter.com/SUCREInstituto?lang=es" target="_blank"><i
                    class="fab fa-twitter"></i></a>

              </li>

              <li><a href="https://www.flickr.com/photos/155422704@N07/albums" target="_blank"><i
                    class="fab fa-flickr"></i></a></li>

              <li><a href="https://www.instagram.com/sucreinstituto/" target="_blank"><i
                    class="fab fa-instagram"></i></a></li>

              <li><a href="https://www.youtube.com/channel/UCqFgzfJwSuh2Z4S1RCUZQGA" target="_blank"><i
          ...
          <div class="float-right">
            ...
            <a class="dn_btn" href="http://www.tecnologicosucre.edu.ec/academico/itssu/index.php" target="_blank">SAGA
              DOCENTES</a>

            <a class="dn_btn" href="http://tecnologicosucre.edu.ec/academico/itssu/loginalumnado.php"
              target="_blank">SAGA ESTUDIANTES</a>

            <a class="dn_btn" href="../sucre-admision.php">ADMISIÓN</a>
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item new-menu">
                      ...
                      <div class="new-submenu">
                        ...
                        <div class="new-nav-item new-menu-2"><a class="new-nav-link">Reglamentos</a>
                    ...
                    <li class="nav-item new-menu">
                      ...
                      <div class="new-submenu">
                        ...
                        <div class="new-nav-item new-menu-2">
                          ...
                          <div class="new-submenu-2">
                            ...
                            <div class="new-nav-item-2">
                              ...
                              <a href="../DProd-y-RealAudiovisual.php" class="new-nav-link-2">Producción y Realización
                        ...
                        <div class="new-nav-item new-menu-2">
                          ...
                          <div class="new-submenu-2">
                            ...
                            <div class="new-nav-item-2">
                              ...
                              <a href="../DDesarrolloInfantil.php" class="new-nav-link-2">Desarrollo Infantil
                                Integral<a>
                        ...
                        <div class="new-nav-item new-menu-2">
                          <a href="https://forms.gle/SyLAYQu1dqXX7n5m9" class="new-nav-link" target="_blank">Registro
                            Docentes</a>
                          <div class="new-submenu-2">
                          </div>
                        </div>
                    ...
                    <li class="nav-item new-menu">
                      ...
                      <div class="new-submenu">
                        ...
                        <div class="new-nav-item new-menu-2">
                          ...
                          <a href="../desarrollo-infantil-integral.php" class="new-nav-link">Desarrollo Infantil Integral</a>

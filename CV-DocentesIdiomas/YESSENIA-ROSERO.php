			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Idiomas/YESSENIA ROSERO CELI 1716925779.jpeg" alt="">

					</div>

					<div class="col-lg-7 c_details_list">

					    <h2 class="Name_Doce">Yessenia Rosero Celi  </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Licenciada en Ciencias de la Educación, mención Plurilingüe de la Universidad Central del Ecuador. </span>
							...
							<li class="list-item-detail">
								...
								<span>yrosero@tecnologicosucre.edu.ec</span>

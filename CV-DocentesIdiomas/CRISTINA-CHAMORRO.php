			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Idiomas/CRISTINA CHAMORRO TAPIA 1722704655.jpeg" alt="">

					</div>

					<div class="col-lg-7 c_details_list">

					    <h2 class="Name_Doce">Cristina Chamorro Tapia  </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Master Universitario en Enseñanza de Español como Lengua Extranjera.</span>
							...
							<li class="list-item-detail">
								...
								<span>cchamorro@tecnologicosucre.edu.ec</span>

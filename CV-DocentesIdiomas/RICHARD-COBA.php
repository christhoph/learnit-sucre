			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Idiomas/RICHARD COBA MORALES 1711256907.jpg" alt="">

					</div>

					<div class="col-lg-7 c_details_list">

					    <h2 class="Name_Doce"> Richard Coba Morales </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Magister en Educación Superior.</span>
							...
							<li class="list-item-detail">
								...
								<span>rcoba@tecnologicosucre.edu.ec</span>

			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Idiomas/ANABEL PORTERO 1802729226.jpg" alt="">

					</div>

					<div class="col-lg-7 c_details_list">

					    <h2 class="Name_Doce">Anabel Portero López </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Magíster en Lingüística y Didáctica de la Enseñanza de Idiomas Extranjeros.</span>
							...
							<li class="list-item-detail">
								...
								<span>aportero@tecnologicosucre.edu.ec</span>

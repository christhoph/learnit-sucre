			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Idiomas/ESTANISLAO PAUTA PILAPANTA 1711873743.jpg" alt="">

					</div>

					<div class="col-lg-7 c_details_list">

					    <h2 class="Name_Doce">Estanislao Pauta Pilapanta  </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Magister en Docencia Universitaria y Administración Educativa.</span>
							...
							<li class="list-item-detail">
								...
								<span>epauta@tecnologicosucre.edu.ec</span>

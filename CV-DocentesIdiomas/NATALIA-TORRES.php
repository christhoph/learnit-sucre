			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Idiomas/NATALIA TORRES PUERTAS 1720216413.jpeg" alt="">

					</div>

					<div class="col-lg-7 c_details_list">

					    <h2 class="Name_Doce">Natalia Torres Puertas </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Máster en Comunicación (mención en Desarrollo y Relaciones Internacionales), The University of Queensland.</span>
							...
							<li class="list-item-detail">
								...
								<span>ntorres@tecnologicosucre.edu.ec</span>

			...
			<div class="col-lg-12 course_details_inner">
				...
				<div class="col-lg-12 row justify-content-between p-0 m-0">
					...
					<div class="col-lg-5">
						...
						<img class="img-fluid-docentecv" src="../img/Docentes/Idiomas/ANDRÉS SIMBAÑA USHIÑA 1717818700.jpeg"  alt="">

					</div>

					<div class="col-lg-7 c_details_list">

					    <h2 class="Name_Doce">Andrés Simbaña Ushiña </h2>
					 ...
					 <ul class="list">
							...
							<li class="list-item-detail">
								...
								<span>Licenciado en Ciencias de la Educación Mención Inglés. </span>
							...
							<li class="list-item-detail">
								...
								<span>asimbana@tecnologicosucre.edu.ec</span>

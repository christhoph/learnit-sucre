...
<section class="course_details_area p_120">
	...
	<div class="container course-container ">
		...
		<h2 class="  text-primary pl-3  ml-5 mr-5 pb-3 pt-3"> RELACIÓNES HUMANAS E INTELIGENCIA </h2>
		<hr>
				...
				<div class="tab-pane fade show active" id="comments" role="tabpanel" aria-labelledby="comments-tab">
					<div class="comments-area">
						<div class="info-rector">
							...
							<center><img src="img/educontinua/educacion_continua.jpg" alt="" width=350px height=250px></center>
						</div>
						<p class="text-justify  ">
							<br>
							Este curso está enfocado en el mejoramiento de interrelación con las personas, aprenderá a resolver
							situaciones de conflicto laboral, conocerá factores importantes que influyen en la comunicación, notando
							los cambios positivos que le resulta al disfrutar de relaciones humanas. </p>
						<br>

						<h6 class="diri colo">COMPETENCIAS DEL PERFIL:</h6>
						<ul class="num">

							<li>Reconocer los factores que intervienen en los tipos de comunicación para mejorar la comunicación y la
								conducta asertiva en la resolución de conflictos.</li>
